    ...
    public class DepartmentBroker : IDepartmentBroker
    {
        ...
        public Constants.DB_STATUS Update(Department department)
        {
            ...
            try
            {
                ...
                {
                    Employee contactId = inventory.Employees.Where(e => e.Id == departmentObj.Employee.Id).First();
                    Employee headId = inventory.Employees.Where(e => e.Id == departmentObj.Employee.Id).First();
                    Employee representativeId = inventory.Employees.Where(e => e.Id == departmentObj.Employee.Id).First();
                    Employee createdBy = inventory.Employees.Where(e => e.Id == departmentObj.Employee.Id).First();
                    ...
                    departmentObj.Employee = contactId;
                    departmentObj.PhoneNumber = department.PhoneNumber;
                    departmentObj.FaxNumber = department.FaxNumber;
                    departmentObj.Employee1 = headId;
                    departmentObj.CollectionPoint = department.CollectionPoint;// collectionPId;
                    //departmentObj.CollectionPoint.Id = department.CollectionPoint.Id;
                    departmentObj.Employee2 = representativeId;
                    departmentObj.CreatedDate = department.CreatedDate;
                    departmentObj.Employee3 = createdBy;
